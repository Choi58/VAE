...
from dataset import *
from bernoulli_vae import *
from bernoulli_learner import *
import time
...
model = VAE().to(device)
if pretraied==True:
    model.load_state_dict(torch.load('model_bernoulli.pth'))
test_data = Test_set()
